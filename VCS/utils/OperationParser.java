...
public final class OperationParser {
    ...
    public AbstractOperation parseOperation(String newOperation) {
        ArrayList<String> operationArgs = new
                ArrayList<>(Arrays.asList(newOperation.split("\\s+")));
    ...
    private AbstractOperation parseVcsOperation(String newOperation,
        ...
        default:
            return operationFactory.createOperation(OperationType.VCS_INVALID_OPEARTION,
                    operationArgs);
        }
    }
